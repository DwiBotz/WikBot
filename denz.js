...
try {
		...
		const ownerNumberr = ["6281261632688@s.whatsapp.net","6281261632688@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
        ...
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'bit.ly/ownerpbotpoxcrafts', "groupName": `${NamaBot}`, "footerText": "*_© UwiiXnxx_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
			...
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === denz.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© UwiXnxx_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
*Uwii Jomblo Need Doi😠!*

𝙶𝚘𝚘𝚍 ${tampilUcapan}
𝚂𝚊𝚢𝚊 𝚄𝚠𝚒𝚒 𝙱𝚘𝚝 𝚈𝚐 𝚂𝚒𝚊𝚙 
𝙼𝚎𝚗𝚐𝚑𝚊𝚖𝚒𝚕𝚒 𝚊𝚗𝚍𝚊
𝙳𝚊𝚕𝚊𝚖 𝙼𝚎𝚖𝚋𝚞𝚊𝚝 𝙰𝚗𝚊𝚔 , 𝙳𝚕𝚕
𝚂𝚒𝚕𝚊𝚑𝚔𝚊𝚗 𝙶𝚞𝚗𝚊𝚔𝚊𝚗 𝙱𝚘𝚝 𝙳𝚎𝚗𝚐𝚊𝚗 𝙱𝚊𝚒𝚔
`
sendButLocation(from, `${menu}`, "*©Created : UwiiXnxx*\n*-ownermenu*\n*-groupmenu*\n*-makermenu*\n*-nsfwmenu*\n*-othermenu*\n*-downloadmenu*\n\n*LINK GRUP: https://chat.whatsapp.com/IU0MR6axRcn8HiTcDLHwue*\n*®UwiiXnxx*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}command`,buttonText:{displayText:'𝐋𝐢𝐬𝐭 𝐌𝐞𝐧𝐮'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'𝐁𝐮𝐚𝐭 𝐀𝐧𝐚𝐤'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
  break
        case 'uwi':
        ptod = "6281261632688@s.whatsapp.net"
        stod = `${sender}`
...
𝚂𝚒𝚕𝚊𝚑𝚔𝚊𝚗 𝙶𝚞𝚗𝚊𝚔𝚊𝚗 𝙱𝚘𝚝 𝙳𝚎𝚗𝚐𝚊𝚗 𝙱𝚊𝚒𝚔
`
sendButLocation(from, `${menu}`, "*©Created : UwiiXnxx*\n*-ownermenu*\n*-groupmenu*\n*-makermenu*\n*-nsfwmenu*\n*-othermenu*\n*-downloadmenu*\n\n *®UwiiXnxx*", {jpegThumbnail:denz.jpeg}, [{buttonId:`${prefix}command`,buttonText:{displayText:'𝐋𝐢𝐬𝐭 𝐌𝐞𝐧𝐮'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'𝐁𝐮𝐚𝐭 𝐀𝐧𝐚𝐤'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
  break
case 'command':
 listMsg = {
 buttonText: '𝐋𝐢𝐬𝐭 𝐌𝐞𝐧𝐮',
 footerText: '*©Created : UwiiXnxx*',
 description: `Hai Kak, Silahkan Pilih MENU BOT Disini..\nJangan Lupa Buat Anak Bersama Uwii`,
 sections: [
                     {
...
break
		...
		case 'sc':
		case 'sourcecode':
		denz.sendMessage(from, { text: "*Ini No Pacar Gw ehh salah owner gw maksud nya* \nwa.me/6281261632688", matchedText: 'wa.me/6281261632688', description: "", title: "Click here🔥!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Owner Uwii - B0T",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/6281261632688?text=Hi Kak Pox>///<"}}})
	}
    }
    }
    }
